...
st.markdown(
    ...
    **Variabel last:** inkluderar laster som kan variera, t.ex. is och våg-last.  
    """
)
...
|---------------------------------|------------------|------------------|----------------|
| Partialfaktor permanent last $\\gamma_d$ | 1.35             | 0.90             | 1.00           |
| Partialfaktor variabel last $\\gamma_d$  | 1.50             | 1.50             | 1.00           |
