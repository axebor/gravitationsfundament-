...
st.markdown(
    ...
    div[data-testid="stTextInput"] > div > input {
        max-width: 120px;  /* Ändra här för att göra fältet smalare/bredare */
    }
    </style>
    """,
...
with col_in:
    ...
    col_b1, col_b2 = st.columns([1, 0.4])  # Smalare högerkolumn
    with col_b1:
    ...
    col_s1, col_s2 = st.columns([1, 0.4])  # Samma smal högerkolumn
    with col_s1:
